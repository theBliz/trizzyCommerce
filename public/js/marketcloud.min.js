...
function(c,a){e("/shippings",c||{},function(b){a(null,b.data)},function(b){a(b.errors[0],null)})};d.shippings.getById=function(c,a){e("/shippings/"+c,{},function(b){a(null,b.data)},function(b){a(b.errors[0],null)})};d.stores.create=function(c,a){g("/stores/",c,function(b){a(null,b.data)},function(b){a(b.errors[0],null)})};d.stores.update=function(c,a,b){n("/stores/"+c,a,function(a){b(null,a.data)},function(a){b(a.errors[0],null)})};d.stores["delete"]=function(c,a){h("/stores/"+c,function(b){a(null,
...
a){g("/users/",c,function(b){a(null,b.data)},function(b){a(b.errors[0],null)})};d.users.update=function(c,a,b){n("/users/"+c,a,function(a){b(null,a.data)},function(a){b(a.errors[0],null)})};d.users["delete"]=function(c,a){h("/users/"+c,function(b){a(null,b.data)},function(b){a(b.errors[0],null)})};d.users.list=function(c,a){e("/users",c||{},function(b){a(null,b.data)},function(b){a(b.errors[0],null)})};d.users.getById=function(c,a){e("/users/"+c,{},function(b){a(null,b.data)},function(b){a(b.errors[0],
null)})};d.users.getCurrent=function(c){if(d.token)e("/users/current",{},function(a){c(null,a.data)},function(a){c(a.errors[0],null)});else throw Error("Cannot get current user information without a user access token. Obtain a user access token first.");};d.users.authenticate=function(c,a,b){d.token=null;d.user=null;g("/users/authenticate",{password:a,email:c},function(a){d.token=a.data.token;d.user=a.data.user;b(null,a.data)},function(a){b(a.errors[0],null)})};d.carts.create=function(c,a){var b=
null,b=c instanceof Array?{items:c}:c;g("/carts",b,function(b){a(null,b.data)},function(b){a(b.errors[0],null)})};d.carts.add=function(c,a,b){if(a instanceof Array)m("/carts/"+c,[{op:"add",items:a}],function(a){b(null,a.data)},function(a){b(a.errors[0],null)});else throw Error("addToCart(cart_id,data,callback) data must be an array [{product_id :1,quantity : 7}]");};d.carts.remove=function(c,a,b){if(a instanceof Array)m("/carts/"+c,[{op:"remove",items:a}],function(a){b(null,a.data)},function(a){b(a.errors[0],
null)});else throw Error("removeFromCart(cart_id,data,callback) data must be an array [{product_id :1,product_id : 7}]");};d.carts.update=function(c,a,b){if(a instanceof Array)m("/carts/"+c,[{op:"update",items:a}],function(a){b(null,a.data)},function(a){b(a.errors[0],null)});else throw Error("removeFromCart(cart_id,data,callback) data must be an array [{product_id :1,product_id : 7}]");};d.carts.getById=function(c,a){e("/carts/"+c,{},function(b){a(null,b.data)},function(b){a(b.errors[0],null)})};
d.carts.getByUser=function(c){if(null===d.user)throw Error("Cannot get current user's cart ca without a user access token. Obtain a user access token first.");e("/carts",{},function(a){c(null,a.data)},function(a){c(a.errors[0],null)})};d.carts["delete"]=function(c,a){h("/carts/"+c,function(b){a(null,b.data)},function(b){a(b.errors[0],null)})};q.marketcloud=d})();
